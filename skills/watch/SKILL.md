...
Output: baseline survey in `.axorbis/artifacts/`, plus a scheduled follow-up only when `schedule_prompt` is visible. If scheduling is unavailable, the workflow records that block instead of claiming a recurring watch exists.
