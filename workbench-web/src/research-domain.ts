import type { WorkbenchArtifact, WorkbenchProject, WorkbenchResearchClaim, WorkbenchRun, WorkbenchState } from "./types.js";
...
export function legacyResearchPath(projectId: string, runSlug: string): string {
	return `/app-shell/projects/${encodeURIComponent(projectId)}/frames/${encodeURIComponent(runSlug)}`;
}
