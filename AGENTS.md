...
- Treat parent CLI wiring as incomplete until the actual Pi launch path is verified: check `engine/pi/launch.ts`, `scripts/prepare-runtime-workspace.mjs`, package `pi.extensions`, and every extension file the launch command passes.
