...
export const extensionCommandSpecs = [
	...
	{ name: "outputs", args: "", section: "Project & Session", description: "Browse all research artifacts (Axorbis project artifacts).", publicDocs: true },
...
export const cliCommandSections = [
	{
		...
		commands: [
			...
			{ usage: "feynman serve [--port N] [--no-open] [--no-auth]", description: "Open Axorbis, the sole web and desktop research interface with Home, Projects, questions, in-place Ask/Deep research with plan approval, synthesized completion findings, click-to-open artifact paths, sources, claims, formatted activity, project-file browsing and management, evidence inspection, AI-provider BYOK and budget settings, and new-release announcements. Feynman's Pi agents, Bio Tools, compute, persistence, and provenance power the workspace. Optional --no-auth provides plain localhost mode for trusted local testing." },
