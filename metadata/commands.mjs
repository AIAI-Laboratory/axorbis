...
export const cliCommandSections = [
	{
		...
		commands: [
			...
			{ usage: "feynman status", description: "Show the current setup summary." },
						{ usage: "feynman serve [--port N] [--no-open] [--no-auth]", description: "Open Axorbis, the researcher-first workspace with Home, Projects, questions, in-place Ask/Deep research, sources, claims, activity, and evidence inspection. Feynman's Pi agents, Bio Tools, compute, persistence, and provenance power the workspace. Optional --no-auth provides plain localhost mode for trusted local testing." },
