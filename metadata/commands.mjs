...
export const cliCommandSections = [
	{
		...
		commands: [
			...
			{ usage: "feynman serve [--port N] [--no-open] [--no-auth]", description: "Open Axorbis, the sole web and desktop research interface with Home, Projects, questions, in-place Ask/Deep research, sources, claims, activity, basic evidence inspection, and new-release announcements. Feynman's Pi agents, Bio Tools, compute, persistence, and provenance power the workspace. Optional --no-auth provides plain localhost mode for trusted local testing." },
